...
{
    public class ExampleRest_Command_MeshProcessor : BaseMeshProcessor
    {
        public ExampleRest_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          ExampleRestConstants.ProviderId;
