...
namespace CluedIn.Crawling.ExampleRest.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IExampleRestClientFactory>().AsFactory())
                .Register(Component.For<ExampleRestClient>().LifestyleTransient());
