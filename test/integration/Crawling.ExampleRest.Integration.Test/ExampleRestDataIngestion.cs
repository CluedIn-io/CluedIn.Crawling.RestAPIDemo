...
{
    public class DataIngestion : IClassFixture<ExampleRestTestFixture>
    {
        private readonly ExampleRestTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(ExampleRestTestFixture fixture, ITestOutputHelper output)
        {
