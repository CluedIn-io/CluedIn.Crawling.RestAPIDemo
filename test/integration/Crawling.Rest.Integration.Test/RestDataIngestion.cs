...
{
    public class DataIngestion : IClassFixture<RestTestFixture>
    {
        private readonly RestTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(RestTestFixture fixture, ITestOutputHelper output)
        {
